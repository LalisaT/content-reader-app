...
export const THEME_PALETTES = [
  { id: 'indigo', name: 'Indigo Modern', primary: '#4f46e5', lightBg: '#eef2ff' },
  { id: 'emerald', name: 'Emerald Forest', primary: '#059669', lightBg: '#ecfdf5' },
  { id: 'violet', name: 'Royal Purple', primary: '#7c3aed', lightBg: '#f5f3ff' },
  { id: 'rose', name: 'Vibrant Rose', primary: '#e11d48', lightBg: '#fff1f2' },
  { id: 'amber', name: 'Sunset Amber', primary: '#d97706', lightBg: '#fffbeb' },
  { id: 'cyan', name: 'Ocean Cyan', primary: '#0891b2', lightBg: '#ecfeff' },
  { id: 'slate', name: 'Minimal Slate', primary: '#334155', lightBg: '#f1f5f9' },
];
